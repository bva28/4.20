...
namespace View
{
	...
	public partial class DataForm : Form
	{
		...
		/// Словарь тип топлива.
		/// </summary>
		private static readonly Dictionary<string, EngineType> _typesFuel = new()
		{
			{"Бензиновый", EngineType.Petrol},
			{"Дизельный", EngineType.Diesel},
			{"Электрический", EngineType.Electricity},
			{"Газотурбинный", EngineType.GasTurbine},
		};
		...
		private void FillComboBoxFuel()
		{
			...
			Dictionary<TypeTransport, string[]> fuelTypes = new()
			{
				...
				},
				{
					...
					[namesTransports[0], namesTransports[2]]
				},
				{
		...
		private void RandomButtonClick(object sender, EventArgs e)
		{
			...
			int mass = Convert.ToInt32(_textBoxMass.Text = random.Next(1, 7).ToString());
