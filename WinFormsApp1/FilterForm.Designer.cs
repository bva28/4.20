namespace View
{
    ...
    partial class FilterForm
    {
		...
		private void InitializeComponent()
		{
			...
			_buttonAgree.Location = new Point(148, 268);
			...
			_checkBoxCapacity.Size = new Size(129, 24);
			...
			_checkBoxMass.Size = new Size(87, 24);
			_checkBoxMass.TabIndex = 2;
			_checkBoxMass.Text = "Масса т.";
			// 
			// _textBoxCapacity
			// 
			_textBoxCapacity.Location = new Point(168, 27);
			_textBoxCapacity.Name = "_textBoxCapacity";
			_textBoxCapacity.Size = new Size(50, 27);
			_textBoxCapacity.TabIndex = 3;
			// 
			// _textBoxMass
			// 
			_textBoxMass.Location = new Point(168, 58);
			_textBoxMass.Name = "_textBoxMass";
			_textBoxMass.Size = new Size(50, 27);
			_textBoxMass.TabIndex = 4;
			// 
			// _groupBoxFilterType
			// 
			...
			_groupBoxFilterType.Location = new Point(12, 20);
			_groupBoxFilterType.Name = "_groupBoxFilterType";
			_groupBoxFilterType.Size = new Size(236, 120);
			...
			_groupBoxFilterData.Location = new Point(12, 150);
			_groupBoxFilterData.Name = "_groupBoxFilterData";
			_groupBoxFilterData.Size = new Size(236, 100);
